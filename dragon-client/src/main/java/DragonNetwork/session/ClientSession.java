...
import DragonNetwork.DragonNetClient;
...
public class ClientSession implements SessionHandler {
    ...
    private void initSession(InetSocketAddress address) {
        ...
        SslContext context = SslContextBuilder.forClient()
                .trustManager(DragonNetClient.class.getResourceAsStream("/certificate/certificate.crt"))
                .build();
        ...
        bootstrap = new Bootstrap()
                ...
                .handler(new DragonNetChannel(this, context));
    ...
    private void initHandshake() {
        ...
        bootstrap.connect().addListener((ChannelFutureListener) listener -> {
            ...
            // Handshake protocol.
            listener.channel().writeAndFlush(new LoginPacket()).addListener((ChannelFutureListener) future -> {
                setConnectionFlag(RECONNECTING, false);
